        ...
        >
            <Layout>
                <div className='flex flex-col ml-8 mr-10 my-12'>
                    <h1 className='text-NeutralBlack font-semibold font-poppins text-xl md:text-3xl py-4'>
                        {t("SEND US YOUR REQUEST!")}
                    </h1>
                    <p className='text-NeutralBlack font-normal font-poppins text-sm md:text-lg mb-4'>
                        {t(
                    ...
                    <div className='flex flex-col justify-center ml-auto mr-auto py-2 bg-gray-200 bg-opacity-50 w-10/12 h-full p-6'>
                        <div className='flex flex-col md:flex-row md:mb-6'>
                            ...
                            <div className='flex justify-center md:w-8/12 lg:w-9/12 xl:w-6/12 max-w-6xl my-6 lg:p-3'>
                                <div className='card bg-Primary w-full md:h-5/6 lg:h-max rounded mx-1 md:mt-auto md:mb-12 lg:mb-9'>
                                    <div className='card-bod py-6 px-9'>
                                        <h2 className='card-title text-NeutralBlack font-poppins font-medium text-xl lg:text-xl'>
                                            <FaLocationDot />
                                            {t("Find Us At")}
                                        </h2>
                                        <p className='text-NeutralBlack font-poppins font-normal text-sm lg:text-lg md:my-4 lg:my-2.5'>
                                            {t("Nergiz Plaza")}
                                            <br />
                                            {t("3rd Floor")}
                                            <br />
                                        ...
                                        <h2 className='card-title text-NeutralBlack font-poppins font-medium text-xl lg:text-xl mt-4'>
                                            <FaPhoneVolume />
                                            {t("Call Us At")}
                                        </h2>
                                        <p className='text-NeutralBlack font-poppins font-normal text-sm lg:text-lg my-4'>
                                            +213 213 213 213
                                        </p>
                                    </div>
                                </div>
