    ...
    return (
        <Layout>
            ...
            >
                ...
                <button className='btn ml-auto font-poppins border-none font-medium text-2xl bg-Accent text-NeutralBlack dark:text-NeutralWhite  dark:bg-Dark_Accent dark:hover:bg-[#3E4E68]  hover:bg-[#879AB8] hover:text-NeutralWhite hover:scale-105 duration-500'>
                    {t("Back to Home")}
                </button>
            </main>
        </Layout>
