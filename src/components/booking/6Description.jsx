            ...
            <div className='w-full h-full px-8 lg:px-20 bg-NeutralWhite flex flex-col '>
                ...
                <div className='self-center flex flex-col w-full h-[500px] lg:w-[70%] lg:h-[350px] mt-14'>
                    ...
                    <textarea
                        id='details'
                        value={description}
                        className='textarea p-4 text-NeutralBlack text-xl font-poppins text-regular bg-white lg:h-full h-[300px] sm:leading-tight shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.42)] rounded-md '
