...
export default function PurchasingSection() {
        ...
        return (
            ...
            >
                <div className='card-body flex flex-col items-center'>
                    ...
                    <h1 className='text-gray-400 text-base md:text-xl'>
                        ${ticketsPrice[index]}
                    </h1>
    ...
    return (
        <div className=' dark:bg-Dark_Neutral dark:text-NeutralWhite bg-BgWhite w-full font-poppins font-extrabold flex flex-col pb-8'>
            ...
            <h1 className='text-xs mx-6  md:text-xl md:mx-9 uppercase'>
            ...
            <div className='flex flex-col items-center'>
                ...
                <div className='card items-center my-2 border-2 rounded-xl shadow-xl w-10/12 h-auto'>
                    <div className='card-body items-center'>
                        <h1 className='card-title my-2 text-base md:mb-4 md:text-3xl md:mx-9 md:mt-10 uppercase text-center'>
                            {t("Are you a counselor?")}
                        </h1>
                        <p className='text-xs my-2 md:text-2xl md:mx-9 text-center'>
                            {t(
