...
function Footer() {
    return (
        <footer className='footer flex justify-between p-3 px-5 bg-[#BFDFDC] text-base-content'>
            <form>
            ...
            <div className=' items-center flex flex-col flex-wrap py-10 '>
                ...
                <div className='grid grid-flow-col gap-4 pr-5'>
                    <a href=''>
                        <svg
                            xmlns='http://www.w3.org/2000/svg'
                            width='35'
