                        ...
                        >
                            ...
                            <div className='mb-5 text-xl flex'>
                                ...
                                <textarea
                                    ...
                                    name='bio'
                                    value={bio}
                                    className='p-4 text-NeutralBlack  w-[68%] h-[40%] text-xl font-poppins font-normal border border-slate-300 bg-NeutralWhite outline-none lg:h-full sm:h-full sm:leading-tight rounded-md resize-none '
